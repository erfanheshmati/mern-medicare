                ...
                <div className="container text-center">
                    ...
                    <div className="max-w-[570px] mt-[30px] mx-auto bg-[#0066ff2c] rounded-md flex items-center justify-between">
                        <input
                            ...
                            className="py-4 pl-4 pr-2 bg-transparent w-full rounded-l-md focus:outline-none placeholder:text-textColor dark:bg-blue-300/50 dark:placeholder:text-slate-300 dark:text-slate-100"
                        />
                        <button
                            onClick={handleSearch}
                            className="btn mt-0 rounded-[0px] rounded-r-md h-14"
                        >
                            Search
                        </button>
                    </div>
